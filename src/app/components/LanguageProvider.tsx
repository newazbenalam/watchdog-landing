...
const bn: Record<string, string> = {
  ...
  "Modern, real-time observability, server telemetry, and uptime monitoring engineered for agile engineering teams and indie builders. Available for Robi and Cirkle users only.": "গতিশীল ইঞ্জিনিয়ারিং টিম এবং ডেভেলপারদের জন্য তৈরি আধুনিক রিয়েল-টাইম পর্যবেক্ষণ, সার্ভার টেলিমেট্রি এবং আপটাইম মনিটরিং। শুধুমাত্র রবি এবং সার্কল ব্যবহারকারীদের জন্য প্রযোজ্য।",
  ...
  "Subscribe with your BDApps mobile number to unlock real-time server telemetry, database monitoring, and unlimited push notifications. Available for Robi and Cirkle users only.": "রিয়েল-টাইম সার্ভার টেলিমেট্রি, ডাটাবেস মনিটরিং এবং পুশ নোটিফিকেশন আনলক করতে আপনার বিডি অ্যাপস নম্বর দিয়ে সাবস্ক্রাইব করুন। শুধুমাত্র রবি এবং সার্কল ব্যবহারকারীদের জন্য প্রযোজ্য।",
  "Coming soon": "শীঘ্রই আসছে",
  "Trial": "ট্রায়াল",
  "Trial access": "ট্রায়াল অ্যাক্সেস",
  "2.78 BDT/day including VAT+SD+Sc. Short-term access for testing WatchLog features.": "ভ্যাট+এসডি+এসসি সহ ২.৭৮ টাকা/দিন। ওয়াচলগ ফিচার পরীক্ষার জন্য স্বল্পমেয়াদি অ্যাক্সেস।",
  ...
  "2.78 BDT/month including VAT+SD+Sc. Recurring monthly access via BDApps mobile balance.": "ভ্যাট+এসডি+এসসি সহ ২.৭৮ টাকা/মাস। বিডি অ্যাপস মোবাইল ব্যালেন্সের মাধ্যমে নিয়মিত মাসিক অ্যাক্সেস।",
  "Daily": "দৈনিক",
  "Daily access": "দৈনিক অ্যাক্সেস",
  "2.78 BDT/day including VAT+SD+Sc. Daily access via BDApps mobile balance.": "ভ্যাট+এসডি+এসসি সহ ২.৭৮ টাকা/দিন। বিডি অ্যাপস মোবাইল ব্যালেন্সের মাধ্যমে দৈনিক অ্যাক্সেস।",
  ...
  "Daily subscription": "দৈনিক সাবস্ক্রিপশন",
  "Confirm your mobile number": "আপনার মোবাইল নম্বর নিশ্চিত করুন",
  "BDApps will send a verification code to activate monthly access at 2.78 BDT/month including VAT+SD+Sc.": "ভ্যাট+এসডি+এসসি সহ মাসিক ২.৭৮ টাকায় অ্যাক্সেস সক্রিয় করতে বিডি অ্যাপস একটি যাচাইকরণ কোড পাঠাবে।",
  "BDApps will send a verification code to activate daily access at 2.78 BDT/day including VAT+SD+Sc.": "ভ্যাট+এসডি+এসসি সহ দৈনিক ২.৭৮ টাকায় অ্যাক্সেস সক্রিয় করতে বিডি অ্যাপস একটি যাচাইকরণ কোড পাঠাবে।",
  "BDApps will send a verification code to activate daily access at 2.78 BDT/day including VAT+SD+Sc. Available for Robi and Cirkle users only.": "ভ্যাট+এসডি+এসসি সহ দৈনিক ২.৭৮ টাকায় অ্যাক্সেস সক্রিয় করতে বিডি অ্যাপস একটি যাচাইকরণ কোড পাঠাবে। শুধুমাত্র রবি এবং সার্কল ব্যবহারকারীদের জন্য প্রযোজ্য।",
  "BDApps mobile number": "বিডি অ্যাপস মোবাইল নম্বর",
  "Send verification code": "যাচাইকরণ কোড পাঠান",
  "Sending code...": "কোড পাঠানো হচ্ছে...",
  "Already subscribed? Check status": "ইতিমধ্যে সাবস্ক্রাইব করেছেন? স্ট্যাটাস দেখুন",
  "Download APK directly": "সরাসরি এপিকে ডাউনলোড করুন",
  "Verify subscription": "সাবস্ক্রিপশন যাচাই",
  "Check subscription status": "সাবস্ক্রিপশন স্ট্যাটাস চেক করুন",
  "Enter your subscribed mobile number to verify active access.": "সক্রিয় অ্যাক্সেস যাচাই করতে আপনার সাবস্ক্রাইব করা মোবাইল নম্বর লিখুন।",
  "Verify active subscription": "সক্রিয় সাবস্ক্রিপশন যাচাই করুন",
  "Checking...": "যাচাই করা হচ্ছে...",
  "Need to subscribe? Go back": "সাবস্ক্রাইব করতে চান? ফিরে যান",
  ...
  "Your BDApps monthly subscription for {phone} is active.": "আপনার বিডি অ্যাপস মাসিক সাবস্ক্রিপশন সক্রিয়।",
  "Your BDApps daily subscription has been confirmed.": "আপনার বিডি অ্যাপস দৈনিক সাবস্ক্রিপশন সফলভাবে নিশ্চিত হয়েছে।",
  "Your BDApps daily subscription for {phone} is active.": "আপনার বিডি অ্যাপস দৈনিক সাবস্ক্রিপশন সক্রিয়।",
